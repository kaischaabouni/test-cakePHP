	...
	<div class="row">
		<div class="col-md-3 col-sm-3 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">	
					<?php echo $this->Html->link(__('Edit Zone'), array('action' => 'edit', $zone['Zone']['id']), array('class' => 'btn btn-default btn-block')); ?>
					<?php echo $this->Form->postLink(__('Delete Zone'), array('action' => 'delete', $zone['Zone']['id']), array('class' => 'btn btn-default btn-block'), __('Are you sure you want to delete # %s?', $zone['Zone']['id'])); ?>
