<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li>
                <a><i class="fa fa-user"></i> Délégués <span class="fa fa-chevron-down"></span></a>
            ...
            <li>
                <a><i class="fa fa-building"></i> Laboratoires <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
            ...
            <li>
                <a><i class="fa fa-map-marker"></i> Régions <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
            ...
            <li>
                <a><i class="fa fa-map-marker"></i> Villes <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
            ...
            <li>
                <a><i class="fa fa-map-marker"></i> Zones <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
