...
<?php echo $this->Form->create('Delegue'); ?>
	<fieldset>
		<legend><?php echo __('Edit Delegue'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Delegue.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Delegue.id'))); ?></li>
